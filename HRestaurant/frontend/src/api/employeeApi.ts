...
export const employeeApi = {
  ...
  create: (input: EmployeeInput) => send<string>("post", "/User", input),
  update: (id: string, input: Partial<Omit<EmployeeInput, "password" | "restaurantId" | "branchId">>) => send("put", `/User/${id}`, input),
